...
const QuickExamples = ({ onExampleClick }) => {
  const examples = [
    {
      title: "React Hooks",
      icon: (
    ...
    },
    {
      ...
      icon: (
        <svg className="w-4 h-4 text-emerald-500" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" /></svg>
      )
    },
    {
  ...
  return (
    <div className="w-full mb-8">
      <div className="flex items-center gap-2 mb-4">
        <h3 className="font-bold text-dark text-lg">Quick Examples</h3>
      ...
      <div className="flex flex-wrap gap-3">
        {examples.map((ex, idx) => (
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 bg-white border border-gray-200 text-gray-700 text-sm font-medium rounded-full shadow-sm hover:border-indigo-200 hover:bg-indigo-50 hover:text-indigo-700 transition-all focus:outline-none focus:ring-2 focus:ring-indigo-100"
          >
            {ex.icon}
            {ex.title}
          </button>
